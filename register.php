      ...
      <div class="glass w-full max-w-[420px] p-6">
        ...
        <form class="space-y-3" action="#" method="post" novalidate>
          <div>
            ...
            <input id="full_name" class="input" type="text" placeholder="e.g. John Doe" required />
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input id="password" class="input" type="password" placeholder="min. 6 characters" required />
            </div>
            <div>
              <label for="confirm_password" class="block text-[13px] mb-1 text-gray-700">Confirm Password</label>
              <input id="confirm_password" class="input" type="password" placeholder="re-enter password" required />
            </div>
          </div>
          ...
          <div class="flex items-center gap-x-9 pt-1">
            <a href="/Dating_app/index.php" class="btn btn-ghost flex-1 text-center">Back to Login</a>
